    ...
    switch (opcao)
     {
        ...
        do {
            let entrada = require("readline-sync");
            let octal = entrada.question("Digite o numero octal: ");
        
            function octalParaBinario(octal: string): string {
                let decimal = parseInt(octal, 8); // Converte octal para decimal
                let binario = '';
                while (decimal > 0) {
            ...
            let resultadoBin = octalParaBinario(octal);

            console.log("--------------");
            console.log(`O valor ${octal} em Binario sera: ${resultadoBin}`);
            console.log("--------------");
            console.log();
        ...
        console.log("----- Você está na operação de CONVERSAO NUMERICA BINARIO PARA OCTAL -----");
         rep = 1
            do {
                ...
                console.log(`O valor binario ${binario} em Octal sera: ${valorOct}`);
                console.log("--------------")
                console.log()
                rep = parseInt(entrada.question("Se desejar realizar uma nova operacao digite [1] para retornar ao menu digite qualquer digito diferente de [1]: "));
        ...
        console.log("----- Você está na operação de CONVERSAO NUMERICA DECIMAL PARA BINARIO -----");
         rep = 1
            do {
                let entrada = require("readline-sync")
                let decabin =entrada.question('Digite o Numero Decimal: ');
                ...
                let resultadobin = decimalParaBinario(decabin);

                console.log("--------------")
                console.log(`O VALOR ${decabin} EM BINÁRIO SERÁ: ${resultadobin}`);
                console.log("--------------")
                    console.log()
                    rep = parseInt(entrada.question("Se desejar realizar uma nova operacao digite [1] para retornar ao menu digite qualquer digito diferente de [1]: "));
        ...
        console.log("----- Você está na operação de CONVERSAO NUMERICA BINARIO PARA DECIMAL -----");
          ...
          do {
            ...
            function isBinary(str: string): boolean {
              ...
              const decimal = binaryToDecimal(binario);
